...
FILE_OUT_37="data/interim/dnms_37_gel.vcf.gz"
FILE_OUT_38="data/interim/dnms_38_gel_raw.vcf.gz"
...
| bcftools sort --write-index=tbi -o "${FILE_OUT_37}"
...
| bcftools sort --write-index=tbi -o "${FILE_OUT_38}"