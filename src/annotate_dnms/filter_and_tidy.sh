...
| awk '
        $5~"stop_gained" {$5="stop_gained"};
        $5~"frameshift_variant" {$5="frameshift_variant"};
        $5~"missense_variant" {$5="missense_variant"};
        $5~"synonymous_variant" {$5="synonymous_variant"};
        1
' \
| awk -v OFS="\t" '
